1. Install node.js
2. Make an application and a bot from the discord website
3. get a text editor, atom or notepad++ would do fine
4. add your quotes to the quotes array variable, format would look like this:
var quotes = [
	"quote1",
	"quote2",
	"quote3"
